...
export const ROOMS_DATA = [
  ...
  },
  {
    id: "premium-room",
    title: "Premium Room",
    description: "Spacious layout with premium furniture, modern bathroom amenities, and a beautiful view overlooking the resort.",
    image: "/assets/images/gallery/bedroom-suite-2.jpeg",
    size: "500 sq. ft.",
    occupancy: "3 Adults or 2 Adults + 2 Children",
    bed: "King Size Bed",
    view: "Pool & Garden View",
    features: ["Private Balcony", "Air Conditioning", "Smart TV", "Mini Fridge", "Electronic Safe", "Complimentary Wi-Fi", "Luxury Toiletries"],
  },
  {
    id: "family-room",
    title: "Family Room",
    description: "A gorgeous duplex room layout offering maximum space, privacy, and scenic nature views, ideal for families.",
